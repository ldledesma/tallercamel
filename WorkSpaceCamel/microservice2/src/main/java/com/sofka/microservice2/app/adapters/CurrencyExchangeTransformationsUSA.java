...
@Component
@Qualifier("USA")
public class CurrencyExchangeTransformationsUSA implements CurrencyExchangeTransformations{
	public Currency processMessage(Currency currency) {
		currency.setExchange(currency.getExchange().multiply(new BigDecimal(4)));
		return currency;
	}
